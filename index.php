...
<body>
    ...
    <div class='header' style='background-color:<?php echo $_SESSION["themecolour"] ?>;'>
        <div class="row">
            ...
            <div class="col">
                <p style="text-align:right;">Welcome,<br><b><?php echo $_SESSION['user_name'] ?></b></p>
            </div>
        </div>
    </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="feature-box col-lg-4">
                        ...
                        <p style="color:#8f8f8f;"><b>Choices are shown according to your BMI, for tailored results.</b>
                        </p>
                    </div>
                    <div class="feature-box col-lg-4">
