    ...
    <div class="main2" style="padding-left:9px;padding-right:12px;">
        ...
        <div>
            ...
            $query = "SELECT MAX(ID) AS ID, TITLE, MEAL_TYPE, COUNT(*) AS COUNT, COST, COST * COUNT(*) AS MEAL_COST, 
                        DISCOUNT_COST * COUNT(*) AS DISCOUNT_COST
                        FROM ORDERS WHERE USER_NAME = '$username' AND PAYMENT_STATUS = 'NOT PAID' AND PAY_ID = '$payid'
                        GROUP BY TITLE, MEAL_TYPE, COST, DISCOUNT_COST
                        ORDER BY MAX(ID)";
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        $query = "SELECT ROUND(SUM(COST)) FROM ORDERS
                    ...
                    <div class="col">
                        ...
                        $query = "SELECT ROUND(SUM(DISCOUNT_COST)) FROM ORDERS
                                WHERE USER_NAME = '$username' AND PAYMENT_STATUS = 'NOT PAID' AND PAY_ID = $payid";
                        $result = $db->querySingle($query);
                        ?>
                ...
                if (isset($_POST['pay'])) {
                    ...
                    $db = new SQLite3('database/SMP.db');
                    $query = "UPDATE ORDERS SET PAYMENT_STATUS = 'PAID' WHERE USER_NAME = '$username' AND PAY_ID = $payid";
                    $result = $db->query($query);
